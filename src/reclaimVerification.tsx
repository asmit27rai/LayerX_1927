...
const BASE_URL = "https://s6tn2xv5-3000.inc1.devtunnels.ms"; // if using ngrok, use the ngrok base url here
...
function StartReclaimVerification({ onVerificationComplete }: StartReclaimVerificationProps) {
